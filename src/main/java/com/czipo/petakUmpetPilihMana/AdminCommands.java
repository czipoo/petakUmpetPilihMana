...
public class AdminCommands implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (label.equalsIgnoreCase("regis")) {
            ...
            showLeaderboard();
            ModMessages.sendToOps("§eGunakan §a/start §euntuk memulai permainan baru.");
        }
            ...
            sender.sendMessage("§a/regis <nama> §7- Daftarkan player ke permainan");
            ...
            sender.sendMessage("§a/start §7- Mulai permainan baru (gacha hunter)");
            sender.sendMessage("§a/nextround §7- Lanjut ke ronde berikutnya");
            sender.sendMessage("§a/resetgame §7- Reset ronde saat ini");
            sender.sendMessage("§a/endgame §7- Akhiri seluruh permainan");
            sender.sendMessage("");
